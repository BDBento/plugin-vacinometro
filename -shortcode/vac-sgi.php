...
/*
function register_vacinometro(){
    register_widget('vacinometro');
}

*/

class novo_vacinometro{
    private static $instace;

    public static function getVacinometro(){
    ...
    private function __construct(){
        add_shortcode('vacinometro',array($this,'vacinometro'));
    }
...
novo_vacinometro::getVacinometro();